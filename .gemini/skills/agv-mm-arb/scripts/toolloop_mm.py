"""
MM-Campaign Tool Loop — 心跳模式（护盘做市）
...
共享基础设施（DexExecutor / Guards / Notify 等）在 toolloop_common.py。
"""
...
# ── 从 common 导入共享基础设施 ────────────────────────
from toolloop_common import (  # noqa: F401 — re-export for backward compat
    # BSC 常量
    ROUTER,
    FACTORY,
    USDT,
...
class MempoolMonitor:
    ...
    async def inspect_pending(self, *, pool_address: str, web3=None) -> list[dict]:
        """检查 pending 交易（链上读取 — stub）"""

"""DataFusion & SignalBus 结构测试（委托到 modules/scan/ 子模块）"""
...
# 导入 scan 子模块
SCAN_SCRIPTS_DIR = Path(__file__).resolve().parent.parent / "modules" / "scan" / "scripts"
sys.path.insert(0, str(SCAN_SCRIPTS_DIR))

from skill_scan import DataFusion, GeckoTerminalClient, _safe_float
from toolloop_scan import SignalBus
